Ext.define('App.modules.cryptos.UI.model.robot.robot', {
        ...
        {name: 'chart_info',
            ...
            gridcolumn: {
                renderer: function(value, meta, record) {
                    ...
                    if (!Ext.isEmpty(chart_info.change_by_robot_html))
                    {
                        html += 'Change ' + chart_info.change_by_robot_html + ': ' + chart_info.change_by_robot_basic_value_html;
                        html += '</br>';
                    }
        ...
        {name: 'candlestick_interval',
            ...
            gridcolumn: {
                renderer: function(value, meta, record) {
                    ...
                    /*if (!Ext.isEmpty(record.get('buying_candlestick_interval')))
                    {
                        ret += "</br>(buy: " + record.get('buying_candlestick_interval') + "m)";
                    }*/
        ...
        {name: 'balance',
            ...
            gridcolumn: {
                renderer: function(value, meta, record) {
                    ...
                    if (record.get('fund') > 0)
                    {
                        var balance_perc = record.get('balance_perc');
                        var balance_perc_text = "";
                        if (balance_perc >= 100)
                        {
                            balance_perc_text = '<font color="red">' + balance_perc + '%' + '</font>';
                        }
                        else
                        {
                            balance_perc_text = balance_perc + '%';
                        }
                        html += ' (<b>' + balance_perc_text + '</b> of ' + record.get('fund') + ')';
                    }
                    return html;
                },
                align: 'center',
